 ...
 *
 * Description:
 *    This is a common header file for the universe driver.
 *
 * Copyright:
...
#define UNIV_CRG_SIZE		4096  /* Combined Register Group (CRG) 4KByte */

/* Byte offsets into the Universe chip for the registers */
...
#define UNIV_DCTL__NO_VINC                  0x00000200
...
#define UNIV_DMA_EVT_DONE                   0x00000800
#define UNIV_DMA_COMPLETION_MASK	        0x00000F00
#define UNIV_DMA_STATUS_MASK                0x00006F00 
...
#define UNIV_LINT__VIRQ_ALL					0x000000FE
...
/* This set of defines is used to clear interrupts */

#define UNIV_LM3_CLEAR		0x00800000
#define UNIV_LM2_CLEAR		0x00400000
#define UNIV_LM1_CLEAR		0x00200000
#define UNIV_LM0_CLEAR		0x00100000
#define UNIV_MBOX3_CLEAR	0x00080000
#define UNIV_MBOX2_CLEAR	0x00040000
#define UNIV_MBOX1_CLEAR	0x00020000
#define UNIV_MBOX0_CLEAR	0x00010000
#define UNIV_ACFAIL_CLEAR	0x00008000
#define UNIV_SYSFAIL_CLEAR	0x00004000
#define UNIV_SW_INT_CLEAR	0x00002000
#define UNIV_SW_IACK_CLEAR	0x00001000
#define UNIV_VERR_CLEAR		0x00000400
#define UNIV_LERR_CLEAR		0x00000200
#define UNIV_DMA_CLEAR		0x00000100
#define UNIV_VIRQ7_CLEAR	0x00000080
#define UNIV_VIRQ6_CLEAR	0x00000040
#define UNIV_VIRQ5_CLEAR	0x00000020
#define UNIV_VIRQ4_CLEAR	0x00000010
#define UNIV_VIRQ3_CLEAR	0x00000008
#define UNIV_VIRQ2_CLEAR	0x00000004
#define UNIV_VIRQ1_CLEAR	0x00000002
#define UNIV_VOWN_CLEAR		0x00000001

#define UNIV_VIRQ_CLEAR(i)	( 0x00000001 << i)
#define UNIV_VINT_CLEAR(i)	( 1 << (24 + (i)))
...
/* To get the bit to enable, use UNIV_INT_ENUM_TO_BIT() with
   a value from the table below */

/* Universe interrupt enumeration, you can use the enum as a bit shift
...
typedef enum
{
  ...
  UNIV_INT_LM_2,
  UNIV_INT_LM_3,
  UNIV_INT_RESERVED_24,
  UNIV_INT_RESERVED_25,
  UNIV_INT_RESERVED_26,
  UNIV_INT_RESERVED_27,
  UNIV_INT_RESERVED_28,
  UNIV_INT_RESERVED_29,
  UNIV_INT_RESERVED_30,
  UNIV_INT_RESERVED_31
} UNIV_INT_LEVEL;

#define UNIV_INT_BIT_TO_ENUM(x) ( log(x)/log(2) )
#define UNIV_INT_ENUM_TO_BIT(x) (1 << x)

#define UNIV_INT_VIRQ_ALL  0x000000FE
#define UNIV_INT_MBOX_MASK 0x000F0000
#define UNIV_INT_LM_MASK   0x00F00000
...
#define UNIV_VINT__LINTALL					0x000000FF			
...
#define UNIV_DCPP__NULL                     0x00000001   
#define UNIV_DCPP__PROCESSED                0x00000002   

/* Layout of a Command Packet Structure Linked-List Descriptor */
typedef struct _UNIV_DMA_DESCRIPTOR 
{
    GEF_UINT32 dctl;    
    GEF_UINT32 dtbc;
    GEF_UINT32 dla;    
    GEF_UINT32 reserved0;
    GEF_UINT32 dva;    
    GEF_UINT32 reserved1;    
    GEF_UINT32 dcpp;   
    GEF_UINT32 reserved2;
} UNIV_DMA_DESCRIPTOR;
